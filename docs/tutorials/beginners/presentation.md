...
> **Bonus question:** Some of you might get the visual areas in your results. Why could that be? Does the fact that an activation pattern 'makes sense' necessarily mean that it's real?
