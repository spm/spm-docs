...
This is necessary because the steps done with custom code are not recorded in the file hostory.
...
!!! danger ""
    ...
    images shold be generated separately for "faces" and "scrambled" i.e. the `maceMdspmeeg_faces_run1.mat` should
